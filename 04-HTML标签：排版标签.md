...
<body>
	<h1>H1：GoodGoodStudy,DayDayUp</h1>
	<h2>H3：GoodGoodStudy,DayDayUp</h2>
	<h3>H3：GoodGoodStudy,DayDayUp</h3>
	<h4>H4：GoodGoodStudy,DayDayUp</h4>
	<h5>H5：GoodGoodStudy,DayDayUp</h5>
	<h6>H6：GoodGoodStudy,DayDayUp</h6>
</body>
</html>
```
...
![img](https://gitee.com/cao_ziqiang/img/raw/master/20210321135603.png)
...
div和span是非常重要的标签，div的语义是division“分割”； span的语义就是span“范围、跨度”。后期在接触框架以前将大篇幅使用“div + css”布局。
...
![Paste_Image.png](https://gitee.com/cao_ziqiang/img/raw/master/20210321135711.png)
