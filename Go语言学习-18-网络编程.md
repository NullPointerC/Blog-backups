...
![osi七层模型](https://gitee.com/cao_ziqiang/img/raw/master/20211105213757.png)

互联网按照不同的模型划分会有不用的分层，但是不论按照什么模型去划分，越往上的层越靠近用户，越往下的层越靠近硬件。在软件开发中我们使用最多的是上图中将互联网划分为五个分层的模型。

![HTTP数据传输图解](https://gitee.com/cao_ziqiang/img/raw/master/20211105214120.png)
...
![socket图解](https://gitee.com/cao_ziqiang/img/raw/master/20211105214149.png)
